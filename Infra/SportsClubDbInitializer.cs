...
namespace Infra
{
    public static class SportsClubDbInitializer
    {
        ...
        private static void InitializeClients(ProjectDbContext db)
        {
        ...
        private static void InitializeCoaches(ProjectDbContext db)
        {
        ...
        private static void InitializeLocations(ProjectDbContext db)
        {
        ...
        private static void InitializeTrainingCategories(ProjectDbContext db)
        {
        ...
        private static void InitializeTrainingTypes(ProjectDbContext db)
        {
        ...
        private static void InitializeTrainings(ProjectDbContext db)
        {
        ...
        private static void InitializeTimetableEntries(ProjectDbContext db)
        {
        ...
        private static void InitializeParticipantsOfTraining(ProjectDbContext db)
        {
